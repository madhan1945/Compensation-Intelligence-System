    ...
    <footer className="border-t border-bg-border bg-bg-card/90 backdrop-blur-md py-12 mt-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-sm font-bold text-text-primary mb-3">Resources</h3>
            <ul className="space-y-2 text-xs text-text-secondary">
              <li>
                <Link href="https://github.com/madhan1945/Compensation-Intelligence-System/blob/master/ADR.md" target="_blank" rel="noreferrer" className="hover:text-accent-blue transition-colors">
                  Architecture (ADR)
                </Link>
              </li>
              <li>
                <Link href="https://github.com/madhan1945/Compensation-Intelligence-System/blob/master/RESEARCH.md" target="_blank" rel="noreferrer" className="hover:text-accent-blue transition-colors">
                  Market Research
                </Link>
              </li>
            </ul>
